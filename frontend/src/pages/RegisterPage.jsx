...
export default function RegisterPage() {
    ...
    const upd = (k) => (e) => { setForm((f) => ({ ...f, [k]: e.target.value })); setErrors((er) => ({ ...er, [k]: "", general: "" })); };
                ...
                <Card className="p-7">
                    <div className="space-y-4">
                        ...
                        <label className="flex items-start gap-2 text-xs cursor-pointer" style={{ color: "var(--text2)" }}>
                            ...
                            I agree to the <span className="font-semibold" style={{ color: "var(--cyan)" }}>Terms</span> and <span className="font-semibold" style={{ color: "var(--cyan)" }}>Privacy Policy</span>
                        </label>
                        <Btn variant="primary" className="w-full py-2.5" loading={loading}>Create Account →</Btn>
                    </div>
                </Card>
